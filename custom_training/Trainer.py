...
class KCTrainer(Trainer):
    ...
    def __init__(
        ...
        assert not self.is_vision_model or self.is_encoder_decoder, f'Not Support encoder_decoder architecture'
        ...
        assert data_collator != None, f'You should implement DataCollator for KCTrainer'
    ...
    def concatenated_forward(
        ...
        w_ct_input_ids, w_ct_labels, w_ct_attention_mask = tuple(batch['w_ct'][key] for key in ("input_ids", "labels", "attention_mask"))
        
        wt_ct_input_ids, wt_ct_labels, wt_ct_attention_mask = tuple(batch['wt_ct'][key] for key in ("input_ids", "labels", "attention_mask"))
        ...
        w_ct_logits = w_ct_outputs.logits
    ...
    def prediction_step(
        ...
        logits_dict = {
            "eval_logits/chosen": metrics["eval_logps/w_ct_logps"],
            "eval_logits/rejected": metrics["eval_logps/wt_ct_logps"],
